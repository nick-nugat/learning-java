...
public class PropertyTestStudent {
	Property propertyOne, propertyTwo;

	@BeforeEach
	public void setUp() throws Exception {
		propertyOne = new Property("Property DEF", "Towson", 8200, "Capital City Bank");
		propertyTwo = new Property("Property GHI", "Williamsburg", 2600, "Global Bank");
	}
	...
	public void testGetPropertyName() {
		...
		assertEquals("Property GHI", propertyTwo.getPropertyName());
	}

	@Test
	public void testGetRentAmount() {
		assertEquals(8200.0, propertyOne.getRentAmount());
		assertEquals(2600.0, propertyTwo.getRentAmount());
	}
